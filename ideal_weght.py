...
def calc_factor(height):  # Считаем коэффициент, в функцию будем передаем рост пользователя - height
    value = 0
    if height <= 165:
        value = 100
    if 166 >= height <= 174:
...
factor = calc_factor(height_of_user)
...
if 20 <= age <= 30:
    if body_type == "small":
        ves = ((height_of_user - factor) - ((height_of_user - factor) * 0.2))  # вычли 20% т.к. вес -10% и тонкость кости -10%
        print(f'У Вас астенический (тонкокостный) тип телосложения, расчетный вес равен: {round(ves)} кг')
    elif body_type == "normal":
        ves = ((height_of_user - factor) - ((height_of_user - factor) * 0.1))  # вычли 10%, т.к. действует условие возраст
        print(f'У Вас нормостенический (нормокостный) тип телосложения, расчетный вес равен: {round(ves)} кг')
    elif body_type == "big":
        ves = (height_of_user - factor)  # не вычитали % , т.к. за возраст должны вычесть 10%, а за ширококстность прибавить.
        print(f'У Вас гиперстенический (ширококостный) тип телосложения, расчетный вес равен: {round(ves)} кг')
if 31 <= age <= 49:
    if body_type == "small":
        ves = ((height_of_user - factor) - ((height_of_user - factor) * 0.1))  # вычли 10% за тонкость кости
        print(f'У Вас астенический (тонкокостный) тип телосложения, расчетный вес равен: {round(ves)} кг')
    elif body_type == "normal":
        ves = (height_of_user - factor)  # нет условий возраст и нет тонкости кости или толстости кости.
        print(f'У Вас нормостенический (нормокостный) тип телосложения, расчетный вес равен: {round(ves)} кг')
    elif body_type == "big":
        ves = ((height_of_user - factor) + ((height_of_user - factor) * 0.1))  # прибавили 10% за толстость кости
        print(f'У Вас гиперстенический (ширококостный) тип телосложения, расчетный вес равен: {round(ves)} кг')
if age >= 50:
    if body_type == "small":
        ves = ((height_of_user - factor) - ((height_of_user - factor) * 0.04))  # вычли 10% за тонкость кости и прибавили 0.6 за возраст
        print(f'У Вас астенический (тонкокостный) тип телосложения, расчетный вес равен: {round(ves)} кг')
    elif body_type == "normal":
        ves = ((height_of_user - factor) + ((height_of_user - factor) * 0.06))  # прибавили 6% за возраст
        print(f'У Вас нормостенический (нормокостный) тип телосложения, расчетный вес равен: {round(ves)} кг')
    elif body_type == "big":
        ves = ((height_of_user - factor) + ((height_of_user - factor) * 0.16))  # прибавили 10% за толстость кости и 6 за возраст
        print(f'У Вас гиперстенический (ширококостный) тип телосложения, расчетный вес равен: {round(ves)} кг')
