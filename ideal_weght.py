...
if 20 <= user_age <= 30:
    if body_type == "small":
        ...
        ves = (user_height - factor)  # не вычитали % , т.к. за возраст должны вычесть 10%, а за ширококстность прибавить.
...
if user_age >= 50:
    if body_type == "small":
        ves = ((user_height - factor) - ((user_height - factor) * 0.04))  # вычли 10% за тонкость кости и прибавили 0.6 за возраст
        print(f'У Вас астенический (тонкокостный) тип телосложения, расчетный вес равен: {round(ves)} кг')
    elif body_type == "normal":
        ves = ((user_height - factor) + ((user_height - factor) * 0.06))  # прибавили 6% за возраст
        print(f'У Вас нормостенический (нормокостный) тип телосложения, расчетный вес равен: {round(ves)} кг')
    elif body_type == "big":
        ves = ((user_height - factor) + ((user_height - factor) * 0.16))  # прибавили 10% за толстость кости и 6 за возраст
        print(f'У Вас гиперстенический (ширококостный) тип телосложения, расчетный вес равен: {round(ves)} кг')
